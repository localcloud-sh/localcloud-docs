...
<CardGroup cols={3}>
    ...
    <Card title="Contact" icon="envelope" href="mailto:dev@localcloud.sh">
        Get in touch for support and collaboration
    </Card>
    <Card title="Discussions" icon="message-circle" href="https://github.com/localcloud-sh/localcloud/discussions">
