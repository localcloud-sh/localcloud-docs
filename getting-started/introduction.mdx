...
LocalCloud is an open-source, local-first AI development platform that eliminates cloud costs during development. Run developer-friendly PostgreSQL, MongoDB, vector databases, AI models, Redis cache, job queues, and S3-like storage instantly on your machine.

<Note>
    LocalCloud lets you develop AI applications locally with the same services you'd use in the cloud, but at **zero cost**. Perfect for AI-assisted development with Claude Code, Cursor, and Gemini CLI.
</Note>
...
- **Tunneling** for secure public access via Cloudflare/Ngrok
...
<CardGroup cols={2}>
    ...
    <Card
        ...
        color="#3b82f6"
    >
        Interactive setup or AI assistant friendly: `lc setup my-app --preset=ai-dev --yes`
    </Card>
    <Card
...
<AccordionGroup>
    ...
    <Accordion title="Integrated Services" icon="server">
        ...
        - **MongoDB 7** for NoSQL document storage
        - **Redis 7** for caching and pub/sub
        - **MinIO** for S3-compatible storage
        - **Whisper** for audio transcription
        - **Tunneling** for secure public access
    </Accordion>
    ...
    <Accordion title="Developer Experience" icon="code">
        ...
        - Non-interactive setup for AI assistants
        - Automatic port management
        - Service health monitoring
        - Integrated logging
        - Auto-generated CLAUDE.md guidance files
    </Accordion>
...
<Tabs>
    <Tab title="Interactive Setup">
        ...
        # Interactive wizard
        lc setup
        # Choose your components and models
    ...
    <Tab title="AI Assistant Setup">
        ...
        # Auto-generates CLAUDE.md with guidance
        ```
    </Tab>
</Tabs>
...
- **Contact**: [dev@localcloud.sh](mailto:dev@localcloud.sh)
