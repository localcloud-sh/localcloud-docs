...
<AccordionGroup>
    <Accordion title="Permission denied when installing">
        ...
        curl -fsSL https://raw.githubusercontent.com/localcloud-sh/localcloud/main/scripts/install.sh | bash -s -- --prefix=$HOME/.local
...
# https://github.com/localcloud-sh/localcloud/releases/latest
```
